...
| `feishu_custom_bitable_list_tables` | 列出 Bitable 应用下的数据表 |
...
| `feishu_custom_bitable_search_records` | 按结构化条件搜索记录 |

### 字段管理

| 工具 | 说明 |
|------|------|
| `feishu_custom_bitable_update_field` | 更新字段配置 |
...
| 工具 | 说明 |
|------|------|
| `feishu_custom_bitable_list_role_members` | 列出角色下的协作者 |
| `feishu_custom_bitable_remove_role_member` | 从角色中移除协作者 |
...
| `feishu_custom_bitable_get_view` | 获取单个视图详情 |
